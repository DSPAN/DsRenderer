...
void Renderer::createGraphicsPipeline(){
    VkShaderModule vertShaderModule = loadShader("shaders/vert.spv",mDevice->getDevice());
    VkShaderModule fragShaderModule = loadShader("shaders/frag.spv",mDevice->getDevice());
    ...
    if (vkCreateGraphicsPipelines(mDevice->getDevice(), VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &mGraphicsPipeline) != VK_SUCCESS) {
